...
public class EnumInventory {
  ...
  /**
   * <b>NOTE:</b> This from/to class maps contains the static, compile-time "class" to "enum name" mapping as defined by
   * the Jandex index.
   */
  ...
  /**
   * @return enum name for specified class {@code clazz} or <code>null</code> if none is found (warning is logged).
   */
