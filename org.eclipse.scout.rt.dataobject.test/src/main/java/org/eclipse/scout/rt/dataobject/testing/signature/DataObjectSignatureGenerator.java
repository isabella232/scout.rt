...
public class DataObjectSignatureGenerator {
   ...
   */
  public static final String VALUE_TYPE_DO_PREFIX = "DO";
   ...
   */
  public static final String VALUE_TYPE_DO_INTERFACE_PREFIX = "DOI";
   ...
   */
  public static final String VALUE_TYPE_ENUM_PREFIX = "ENUM";
   ...
   * Require a type id.
   */
  public static final String VALUE_TYPE_ID_PREFIX = "ID";

  /**
   * Used for FQN of supported attribute types ({@link #m_supportedAttributeTypes}).
   */
  public static final String VALUE_TYPE_CLASS_PREFIX = "CLASS";
  ...
  protected void init() {
    ...
    m_supportedAttributeTypes = BEANS.all(IDataObjectSignatureTestConfigurationCollector.class).stream()
  ...
  protected String processClass(Class<?> clazz, Class<? extends IDoEntity> containingEntityClass, String containingAttributeName) {
    ...
    m_errors.add(String.format("Unsupported class type '%s' referenced in '%s' (check for missing dependencies on %s implementors)",
        ...
        IDataObjectSignatureTestConfigurationCollector.class.getName()));
  ...
  protected static String box(String type, String name) {
    return type + "[" + name + "]";
  }
