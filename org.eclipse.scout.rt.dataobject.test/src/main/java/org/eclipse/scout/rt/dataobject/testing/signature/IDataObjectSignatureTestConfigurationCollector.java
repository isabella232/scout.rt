 ...
 */
@ApplicationScoped
public interface IDataObjectSignatureTestConfigurationCollector {

  /**
   * Supported types for data object attributes nodes.
   * <p>
   * Subclasses of {@link IDoEntity}, {@link IEnum} and {@link IId} are handled explicitly and must not be part of the
   * supported types.
   */
